...
if(l79EDDB03_0)
{
	...
	if(l27EA3120_0)
	{
		...
		if (l70F7E046_0)
		{
			...
			/// @DnDArgument : "xpos" "tempx"
			/// @DnDArgument : "ypos" "tempy"
			/// @DnDArgument : "objectid" "obj_bazooka"
			/// @DnDSaveInfo : "objectid" "4354a6af-28a3-4462-9c21-5c986dfb395a"
			instance_create_layer(tempx, tempy, "Instances", obj_bazooka);
		}
	}
}
